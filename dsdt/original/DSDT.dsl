 ...
 *
 * Disassembly of DSDT.aml, Thu Apr  7 15:41:07 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00012A28 (76328)
 *     Revision         0x02
 *     Checksum         0xE4
 *     OEM ID           "Apple "
 ...
 */
DefinitionBlock ("", "DSDT", 2, "Apple ", "ACRPRDCT", 0x00000000)
{
    /*
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x9CFBAC18, 0x0383)
    ...
    OperationRegion (OGNS, SystemMemory, 0x9CFB7F98, 0x0000000C)
    ...
    Scope (_SB.PCI0.I2C1)
    {
        ...
        Device (TPD7)
        {
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If (LAnd (LEqual (TPSW, One), LEqual (CMSR (0x6F), 0x02)))
                {
                    Return (0x0F)
                }
        ...
        Device (TPD8)
        {
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If (LAnd (LEqual (TPSW, One), LEqual (CMSR (0x6F), One)))
                {
                    Return (0x0F)
                }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Method (_INI, 0, Serialized)  // _INI: Initialize
        {
            ...
            ElseIf (LNotEqual (CMSR (0x6D), Zero))
            {
                CMSW (0x6D, Zero)
            }
            ...
            ElseIf (LNotEqual (CMSR (0x6C), 0xAA))
            {
                CMSW (0x6C, 0xAA)
            }
    ...
    OperationRegion (MDBG, SystemMemory, 0x9CF8E018, 0x00001004)
    ...
    Scope (\)
    {
        OperationRegion (COMP, SystemMemory, 0x9CFBCC98, 0x00000200)
